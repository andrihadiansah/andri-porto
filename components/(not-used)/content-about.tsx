    ...
    <div>
      ...
      <section>
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6 text-balance">
          My full name is Andri Hadiansah, and I entered this world on April 27,
          1998. Currently, I call Bandung, Indonesia, my home sweet home. I
          graduated with a bachelor's degree in Communication Science from
          UNIKOM Bandung in late 2021. Following my graduation, I got married.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          reprehenderit, molestias, quod aliquam impedit officiis. Lorem ipsum
          dolor sit amet consectetur adipisicing elit. Et, nulla aliquam quam
          corporis tenetur temporibus saepe, odio accusantium quae doloremque
          similique, ducimus eos illo. Maxime minima molestias possimus aut
          veritatis.
        </p>
      </section>
      <section>
